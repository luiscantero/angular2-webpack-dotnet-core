...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs__ = __webpack_require__(5);
...
var Headers = /** @class */ (function () {
    ...
    function () {
        ...
        this._headers.forEach(function (values, name) {
            var split = [];
            values.forEach(function (v) { return split.push.apply(split, Object(__WEBPACK_IMPORTED_MODULE_1_tslib__["d" /* __spread */])(v.split(','))); });
...
function paramParser(rawParams) {
    ...
    if (rawParams.length > 0) {
        ...
        params.forEach(function (param) {
            ...
            var _a = Object(__WEBPACK_IMPORTED_MODULE_1_tslib__["c" /* __read */])(eqIdx == -1 ? [param, ''] : [param.slice(0, eqIdx), param.slice(eqIdx + 1)], 2), key = _a[0], val = _a[1];
...
var JSONPConnection = /** @class */ (function () {
    ...
    function JSONPConnection(req, _dom, baseResponseOptions) {
        ...
        this.request = req;
        this.response = new __WEBPACK_IMPORTED_MODULE_2_rxjs__["Observable"](function (responseObserver) {
...
var CookieXSRFStrategy = /** @class */ (function () {
    ...
    CookieXSRFStrategy.prototype.configureRequest = function (req) {
        var xsrfToken = Object(__WEBPACK_IMPORTED_MODULE_3__angular_platform_browser__["ɵgetDOM"])().getCookie(this._cookieName);
        if (xsrfToken) {
 ...
 * @deprecated use @angular/common/http instead
 */
var VERSION = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["Version"]('6.0.2');
